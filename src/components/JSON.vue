...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul v-for="author in austen" :key="author">
        <p>{{ author?.name }}'s works:</p>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(value, name) in bookstores.storeTypes" :key="name">
          Store Type: {{ name }} has {{ value }} stores
        </li>
      </ul>
      ...
      <ul>
        <li v-for="(value, name) in bookstores.openingHours" :key="name">
          {{ name }}: open {{ value.open }} and closes: {{ value.close }}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id" :style="{ back }" :class="{ 'highlight': author.name === 'George Orwell' }" >
          {{ author.name }}
        </li>
      </ul>
